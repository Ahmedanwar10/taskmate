    ...
    result.fold(
      ...
      (loginData) async {
        if (loginData.accessToken != null &&
          ...
          print(
              "✅ تم تخزين Access Token في Hive: ${tokenBox.get('access_token')}");
          print(
              "✅ تم تخزين Refresh Token في Hive: ${tokenBox.get('refresh_token')}");
          ...
          emit(LoginFailure(
              errorMessage:
                  ServerFailure(S.current.data_not_valid).errorMessage));
        }
      },
    );
  }
